...
pub trait IsInstance<Ty: ?Sized> {
    fn refl_with(self, _wit: &IsWit<Self, Ty>) -> Ty
    where
        Self: Sized,
        Ty: Sized;

    fn inv_refl_with(this: Ty, _wit: &IsWit<Self, Ty>) -> Self
    where
        Self: Sized,
        Ty: Sized;

    fn refl_ref_with(&self, _wit: &IsWit<Self, Ty>) -> &Ty;

    fn inv_refl_ref_with<'a>(this: &'a Ty, _wit: &IsWit<Self, Ty>) -> &'a Self;

    fn refl_mut_with(&mut self, _wit: &IsWit<Self, Ty>) -> &mut Ty;

    fn inv_refl_mut_with<'a>(this: &'a mut Ty, _wit: &IsWit<Self, Ty>) -> &'a mut Self;
}
...
mod impls {
    ...
    impl<L: ?Sized, R: ?Sized> const IsInstance<R> for L {
        #[inline(always)]
        default fn refl_with(self, _wit: &IsWit<Self, R>) -> R
        where
            Self: Sized,
            R: Sized,
        {
        ...
        #[inline(always)]
        default fn inv_refl_with(_this: R, _wit: &IsWit<Self, R>) -> Self
        where
            Self: Sized,
            R: Sized,
        {
        ...
        #[inline(always)]
        default fn refl_ref_with(&self, _wit: &IsWit<Self, R>) -> &R {
            unreachable!()
        }

        #[inline(always)]
        default fn inv_refl_ref_with<'a>(_this: &'a R, _wit: &IsWit<Self, R>) -> &'a Self {
            unreachable!()
        }

        #[inline(always)]
        default fn refl_mut_with(&mut self, _wit: &IsWit<Self, R>) -> &mut R {
            unreachable!()
        }

        #[inline(always)]
        default fn inv_refl_mut_with<'a>(_this: &'a mut R, _wit: &IsWit<Self, R>) -> &'a mut Self {
            unreachable!()
        }
    }
    impl<L: ~const Is<Ty = R> + ?Sized, R: ?Sized> const IsInstance<R> for L {
        #[inline(always)]
        fn refl_with(self, _wit: &IsWit<Self, R>) -> R
        where
            Self: Sized,
            R: Sized,
        {
        ...
        #[inline(always)]
        fn inv_refl_with(this: R, _wit: &IsWit<Self, R>) -> Self
        where
            Self: Sized,
            R: Sized,
        {
        ...
        #[inline(always)]
        fn refl_ref_with(&self, _wit: &IsWit<Self, R>) -> &R {
            self.refl_ref()
        }

        #[inline(always)]
        fn inv_refl_ref_with<'a>(this: &'a R, _wit: &IsWit<Self, R>) -> &'a Self {
            Self::inv_refl_ref(this)
        }

        #[inline(always)]
        fn refl_mut_with(&mut self, _wit: &IsWit<Self, R>) -> &mut R {
            self.refl_mut()
        }

        #[inline(always)]
        fn inv_refl_mut_with<'a>(this: &'a mut R, _wit: &IsWit<Self, R>) -> &'a mut Self {
